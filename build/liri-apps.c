/* liri-apps.c generated by valac 0.32.1, the Vala compiler
 * generated from liri-apps.vala, do not modify */
...
SlingshotWindow* slingshot_window_construct (GType object_type) {
	...
	SlingshotFrontendSearchbar* _tmp56_ = NULL;
	SlingshotFrontendSearchbar* _tmp57_ = NULL;
	gint medio = 0;
	GdkRectangle _tmp58_ = {0};
	gint _tmp59_ = 0;
	GtkHBox* _tmp60_ = NULL;
	SlingshotFrontendSearchbar* _tmp61_ = NULL;
	gint _tmp62_ = 0;
	GtkVBox* _tmp63_ = NULL;
	GtkHBox* _tmp64_ = NULL;
	...
	SlingshotFrontendIndicators* _tmp76_ = NULL;
	...
	gint _tmp82_ = 0;
	SlingshotFrontendIndicators* _tmp93_ = NULL;
	...
	_tmp28_ = (GtkVBox*) gtk_vbox_new (FALSE, 15);
	...
	_tmp51_ = (GtkHBox*) gtk_hbox_new (FALSE, 20);
	g_object_ref_sink (_tmp51_);
	_g_object_unref0 (self->top_spacer);
	self->top_spacer = _tmp51_;
	_tmp52_ = self->top_spacer;
	g_signal_connect_object ((GtkWidget*) _tmp52_, "realize", (GCallback) ___lambda14__gtk_widget_realize, self, 0);
	_tmp53_ = self->top_spacer;
	g_object_set ((GtkWidget*) _tmp53_, "can-focus", TRUE, NULL);
	_tmp54_ = bottom;
	_tmp55_ = self->top_spacer;
	gtk_box_pack_start ((GtkBox*) _tmp54_, (GtkWidget*) _tmp55_, FALSE, FALSE, (guint) 0);
	_tmp56_ = slingshot_frontend_searchbar_new ("Empiece a escribir para buscar...");
	g_object_ref_sink (_tmp56_);
	_g_object_unref0 (self->searchbar);
	self->searchbar = _tmp56_;
	_tmp57_ = self->searchbar;
	g_signal_connect_object (_tmp57_, "changed", (GCallback) _slingshot_window_search_slingshot_frontend_searchbar_changed, self, 0);
	_tmp58_ = monitor_dimensions;
	_tmp59_ = _tmp58_.width;
	medio = (_tmp59_ / 2) - 120;
	_tmp60_ = bottom;
	_tmp61_ = self->searchbar;
	_tmp62_ = medio;
	gtk_box_pack_start ((GtkBox*) _tmp60_, (GtkWidget*) _tmp61_, TRUE, TRUE, (guint) _tmp62_);
	_tmp63_ = container;
	_tmp64_ = bottom;
	gtk_box_pack_start ((GtkBox*) _tmp63_, (GtkWidget*) _tmp64_, FALSE, TRUE, (guint) 20);
	_tmp65_ = container;
	_tmp66_ = top;
	gtk_box_pack_start ((GtkBox*) _tmp65_, (GtkWidget*) _tmp66_, FALSE, TRUE, (guint) 0);
	_tmp67_ = monitor_dimensions;
	_tmp68_ = _tmp67_.width;
	_tmp69_ = monitor_dimensions;
	_tmp70_ = _tmp69_.height;
	if (_tmp68_ > _tmp70_) {
		SlingshotFrontendGrid* _tmp71_ = NULL;
		_tmp71_ = slingshot_frontend_grid_new (4, 6);
		g_object_ref_sink (_tmp71_);
		_g_object_unref0 (self->grid);
		self->grid = _tmp71_;
	} else {
		SlingshotFrontendGrid* _tmp72_ = NULL;
		_tmp72_ = slingshot_frontend_grid_new (6, 4);
	...
	_tmp73_ = container;
	_tmp74_ = self->grid;
	gtk_box_pack_start ((GtkBox*) _tmp73_, (GtkWidget*) _tmp74_, TRUE, TRUE, (guint) 0);
	slingshot_window_populate_grid (self);
	_tmp75_ = slingshot_frontend_indicators_new ();
	g_object_ref_sink (_tmp75_);
	_g_object_unref0 (self->pages);
	self->pages = _tmp75_;
	_tmp76_ = self->pages;
	g_signal_connect_object (_tmp76_, "child-activated", (GCallback) ___lambda19__slingshot_frontend_indicators_child_activated, self, 0);
	_tmp77_ = (GtkHBox*) gtk_hbox_new (FALSE, 0);
	g_object_ref_sink (_tmp77_);
	pages_wrapper = _tmp77_;
	_tmp78_ = pages_wrapper;
	gtk_widget_set_size_request ((GtkWidget*) _tmp78_, -1, 30);
	_tmp79_ = container;
	_tmp80_ = pages_wrapper;
	gtk_box_pack_end ((GtkBox*) _tmp79_, (GtkWidget*) _tmp80_, FALSE, TRUE, (guint) 15);
	_tmp81_ = self->apps;
	slingshot_window_update_pages (self, _tmp81_);
	_tmp82_ = self->total_pages;
	if (_tmp82_ > 1) {
		GtkHBox* _tmp83_ = NULL;
		SlingshotFrontendIndicators* _tmp84_ = NULL;
		_tmp83_ = pages_wrapper;
		_tmp84_ = self->pages;
		gtk_box_pack_start ((GtkBox*) _tmp83_, (GtkWidget*) _tmp84_, TRUE, FALSE, (guint) 0);
		{
			gint p = 0;
			p = 1;
			{
				...
				while (TRUE) {
					gint _tmp87_ = 0;
					gint _tmp88_ = 0;
					SlingshotFrontendIndicators* _tmp89_ = NULL;
					gint _tmp90_ = 0;
					gchar* _tmp91_ = NULL;
					gchar* _tmp92_ = NULL;
					if (!_tmp85_) {
					...
					_tmp85_ = FALSE;
					_tmp87_ = p;
					_tmp88_ = self->total_pages;
					if (!(_tmp87_ <= _tmp88_)) {
						break;
					}
					_tmp89_ = self->pages;
					_tmp90_ = p;
					_tmp91_ = g_strdup_printf ("%i", _tmp90_);
					_tmp92_ = _tmp91_;
					slingshot_frontend_indicators_append (_tmp89_, _tmp92_);
					_g_free0 (_tmp92_);
				}
			}
		}
	...
	_tmp93_ = self->pages;
	slingshot_frontend_indicators_set_active (_tmp93_, 0);
...
static gboolean slingshot_window_draw_background (SlingshotWindow* self, GtkWidget* widget, GdkEventExpose* event) {
	...
	cairo_set_source_rgba (context, (gdouble) 0, (gdouble) 0, (gdouble) 0, 0.94);
	cairo_paint (context);
	result = FALSE;
